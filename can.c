/***********************************************************************************************************************
 * File Name    : can.c
 * Description  : Contains data structures and functions to setup CAN module for broadcast/receive.
 **********************************************************************************************************************/
/***********************************************************************************************************************
...
/*******************************************************************************************************************//**
 * @brief       This function initializes the CAN BUS.
 * @param       None
 * @return      None
 **********************************************************************************************************************/
void can_init(void)
...
/*******************************************************************************************************************//**
 * @brief      This function is the entry point for the CAN application.
 * @param[in]  none
 * @retval     none
 **********************************************************************************************************************/
void can_entry (void)
...
/*******************************************************************************************************************//**
 * @brief      This function processes and prints any received CAN message.
 *
 * @param[in]  p_node  Pointer to the CAN node that received the message.
 * @retval     none
 **********************************************************************************************************************/
void process_message(can_node_t *p_node)
{
...
/*******************************************************************************************************************//**
 * @brief      Main operational loop. Continuously transmits on CH0 and checks for received messages.
 *
 * @param[in]  none
 * @retval     none
 **********************************************************************************************************************/
void can_run(void)
{
    ...
    APP_PRINT("\r\nStarting continuous broadcast on Channel 0...\r\n");
 ...
 *
 * @param[in]  p_node     Pointer to the CAN node to transmit from.
 * @param[in]  p_frame    Pointer to the CAN frame to transmit.
 * @retval     FSP_SUCCESS if the frame was copied to the transmit buffer successfully.
 * @retval     Other fsp_err_t codes on failure (e.g., FSP_ERR_CAN_FIFO_OVERFLOW).
 **********************************************************************************************************************/
fsp_err_t can_transmit(can_node_t *p_node, can_frame_t *p_frame)
{
     fsp_err_t status;

     status = R_CAN_Write(p_node->p_ctrl, 4, p_frame);
